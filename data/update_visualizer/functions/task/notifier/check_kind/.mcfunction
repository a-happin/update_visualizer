...
data modify storage : _ append value {}
  ...
  execute if data storage : _[-1].switch{case: "block_update"} run function update_visualizer:task/notifier/check_duplicate/block_update/
  execute if data storage : _[-1].switch{case: "observer_update"} run function update_visualizer:task/notifier/check_duplicate/observer_update/
