#> update_visualizer:summon/notifier_marker/block_update/impl
#@within function update_visualizer:summon/notifier_marker/block_update/
...
## team
team join update_visualizer.block_update @s
